    ...
    >
      <div id="nav" data-section="nav">
        <NavbarStyleFullscreen
          brandName="La'H Cafe"
          logoSrc={resolveAsset("http://img.b2bpic.net/free-vector/coffee-shop-logo-template_23-2150529622.jpg")}
      ...
      <div id="hero" data-section="hero">
        <HeroSplitTestimonial
          ...
          testimonials={[
            { name: "Sarah J.", handle: "@coffeeLover", testimonial: "La'H Cafe offers an unparalleled coffee experience. The ambiance is truly something special!", rating: 5, imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/gorgeous-smiling-blonde-fashion-model-sits-white-suit-soft-armchair_8353-5476.jpg"), imageAlt: "Sarah J. testimonial avatar" },
            { name: "Michael K.", handle: "@kampalaFoodie", testimonial: "Every visit feels like a luxurious escape. The pastries are divine!", rating: 5, imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/happy-young-elegant-man-smiling_23-2148332976.jpg"), imageAlt: "Michael K. testimonial avatar" },
            { name: "Emily R.", handle: "@travelBug", testimonial: "A truly world-class cafe right here in Kampala. The espresso is perfect.", rating: 5, imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/medium-shot-smiley-woman-with-coffee-cup_23-2149005429.jpg"), imageAlt: "Emily R. testimonial avatar" }
          ]}
          mediaAnimation="slide-up"
          useInvertedBackground={false}
          imageSrc={resolveAsset("http://img.b2bpic.net/free-photo/hot-cup-cappuccino-with-cinnamon_140725-7516.jpg")}
      ...
      <div id="about" data-section="about">
        <SplitAbout
          ...
          imageSrc={resolveAsset("http://img.b2bpic.net/free-photo/machine-making-coffee_23-2148892815.jpg")}
      ...
      <div id="menu" data-section="menu">
        <ProductCardOne
          ...
          products={[
            { id: "cappuccino", name: "Cappuccino", price: "UGX 15,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/trendy-coffee-shop-city_53876-65010.jpg"), imageAlt: "Realistic Cappuccino with latte art" },
            { id: "espresso", name: "Espresso", price: "UGX 10,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/selective-focus-point-black-coffee-white-cup_74190-3898.jpg"), imageAlt: "Rich Espresso shot" },
            { id: "latte", name: "Latte", price: "UGX 16,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/top-view-glass-coffee-with-latte-art_140725-5204.jpg"), imageAlt: "Creamy Latte with foam art" },
            { id: "iced-coffee", name: "Iced Coffee", price: "UGX 18,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/glasses-with-coffee-rustic-table_23-2147693441.jpg"), imageAlt: "Refreshing Iced Coffee" },
            { id: "milkshake", name: "Milkshakes", price: "UGX 22,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/top-view-yummy-waffle-cookies-with-fresh-red-strawberries-macarons-light-pink-surface_140725-81116.jpg"), imageAlt: "Indulgent Chocolate Milkshake" },
            { id: "smoothies", name: "Smoothies", price: "UGX 20,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/cold-berry-cocktail-table_141793-75.jpg"), imageAlt: "Healthy Mixed Berry Smoothie" },
            { id: "cakes", name: "Cakes & Desserts", price: "UGX 25,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/top-view-yummy-creamy-cake-with-raisins-cup-tea-light-dark-background_140725-80174.jpg"), imageAlt: "Slice of elegant Chocolate Cake" },
            { id: "juices", name: "Fresh Juices", price: "UGX 17,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/orange-juice-with-oranges-squeezer-jug-white-surface_176474-6100.jpg"), imageAlt: "Freshly squeezed Orange Juice" },
            { id: "african-tea", name: "African Tea", price: "UGX 12,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/steam-rises-cup-espresso-coffee-glass-water-cookies-table-closeup-sunlight-selective-focus-empty-space-cafe-breakfast-advertising-banner_166373-2882.jpg"), imageAlt: "Traditional African Tea" },
            { id: "mojitos", name: "Mojitos (Virgin)", price: "UGX 19,000", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/summer-detox-drink-with-cucumber-lime-concept-refreshing-drinks_169016-4629.jpg"), imageAlt: "Refreshing non-alcoholic Mojito" }
          ]}
        ...
        <FeatureBento
          ...
          features={[
            { title: "Experience Our World", description: "A curated collection of our cafe's essence, captured in cinematic detail.", bentoComponent: "media-stack", items: [
              { imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/vintage-light-lamp_1203-3090.jpg"), imageAlt: "Night cafe aesthetics with warm lighting" },
              { imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/close-up-hand-holding-coffee-filter-tamper_23-2148349619.jpg"), imageAlt: "Barista preparing coffee" },
              { imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/top-view-little-creamy-cake-with-chocolate-cookies-cup-tea-dark-surface-biscuit-cake-sweet-pie-sugar-cookies_140725-118176.jpg"), imageAlt: "Assortment of elegant desserts" },
              { imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/coffee-making-concept-with-machine_23-2149045704.jpg"), imageAlt: "Close-up of coffee preparation" },
              { imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/beautiful-girl-drinking-coffee-cafe_72229-1426.jpg"), imageAlt: "Cozy corner in the cafe" },
              { imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/portrait-man-summertime-80-s-aesthetic-beach-chair_23-2150835806.jpg"), imageAlt: "Elegant outdoor seating area" }
            ] }
          ]}
          animationType="blur-reveal"
          textboxLayout="default"
      ...
      <div id="testimonials" data-section="testimonials">
        <TestimonialCardTwelve
          ...
          testimonials={[
            { id: "1", name: "Amina S.", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/gorgeous-smiling-blonde-fashion-model-sits-white-suit-soft-armchair_8353-5476.jpg"), imageAlt: "Amina S. testimonial avatar" },
            { id: "2", name: "Brian L.", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/happy-young-elegant-man-smiling_23-2148332976.jpg"), imageAlt: "Brian L. testimonial avatar" },
            { id: "3", name: "Charlotte P.", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/medium-shot-smiley-woman-with-coffee-cup_23-2149005429.jpg"), imageAlt: "Charlotte P. testimonial avatar" },
            { id: "4", name: "Daniel M.", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/young-handsome-man-grey-shirt-looking-front-with-clenched-fists-happy-excited-standing-pink-wall_141793-52902.jpg"), imageAlt: "Daniel M. testimonial avatar" },
            { id: "5", name: "Grace N.", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/smiley-woman-posing-her-home_23-2148708980.jpg"), imageAlt: "Grace N. testimonial avatar" },
            { id: "6", name: "Paul E.", imageSrc: resolveAsset("http://img.b2bpic.net/free-photo/blond-businessman-with-glasses_1098-57.jpg"), imageAlt: "Paul E. testimonial avatar" }
          ]}
      ...
      <div id="contact" data-section="contact">
        <ContactSplit
          ...
          useInvertedBackground={false}
          imageSrc={resolveAsset("http://img.b2bpic.net/free-photo/close-up-camera-map_23-2147950737.jpg")}
      ...
      <div id="footer" data-section="footer">
        <FooterMedia
          videoSrc={resolveAsset("http://img.b2bpic.net/free-photo/abstract-gradient-background-with-grainy-effect_84443-3122.jpg")}
